...
public class Constants {
  ...
  public static final String LI_ME_ENDPOINT = "https://api.linkedin.com/v2/userinfo?oauth2_access_token=";
  ...
  public static final String USER_AGENT_OAUTH_VALUE = String.format("%s (%s, %s)", SAMPLE_APP_BASE, SAMPLE_APP_VERSION,
      AppName.OAuth.name());
  public static final String USER_AGENT_LMS_VALUE = String.format("%s (%s, %s)", SAMPLE_APP_BASE, SAMPLE_APP_VERSION,
      AppName.Marketing.name());
